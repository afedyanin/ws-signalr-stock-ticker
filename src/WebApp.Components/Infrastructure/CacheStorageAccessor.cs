...
namespace WebApp.Components.Infrastructure;
public class CacheStorageAccessor(IJSRuntime js) : JSModule(js, "./_content/WebApp.Components/js/CacheStorageAccessor.js")
{
